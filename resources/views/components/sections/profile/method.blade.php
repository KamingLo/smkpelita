<section class="max-w-7xl mx-auto mt-16 mb-32">
    ...
    @php
        $methodologies = [
            ...
            [
                'title' => 'Disiplin berbasis budaya kerja',
                'desc' => 'Menerapkan praktik pembelajaran dengan nilai nilai keimanan, disiplin, dan tanggung jawab, etos kerja profesional, integritas dan kejujuran, teamwork, komunikatif, keselamatan dan kesehatan kerja, kreatif inovatif dan beradaptasi dengan teknologi. Disamping itu penanaman jiwa kewirausahaan bagi seluruh siswa SMK Pelita IV',
                'color' => 'text-blue-600',
                'delay' => '200',
                // Icon: Heart/Shield
            ...
            [
                'title' => 'Kurikulum Terintegrasi Industri',
                'desc' => 'Penyelarasan kurikulum dengan mitra dunia kerja, memastikan setiap materi yang diajarkan siap diaplikasikan saat siswa lulus nanti. Pola kemitraan industri tertuang dalam program magang kerja, teaching factory, dan Program magang guru.',
                'color' => 'text-blue-600',
                'delay' => '300',

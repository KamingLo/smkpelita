        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="mb-16" data-aos="fade-up">
                <div class="flex items-center gap-6 mb-8">
                    {{-- Badge Warna Dinamis --}}
                    <span class="px-6 py-2 rounded-full text-xl font-bold 
                        {{ $post->type == 'berita' ? 'bg-blue-50 text-blue-500' : 
                           ($post->type == 'prestasi' ? 'bg-emerald-50 text-emerald-500' : 'bg-orange-50 text-orange-500') }}">
                        {{ ucfirst($post->type) }}
                    </span>
